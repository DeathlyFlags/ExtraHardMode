 ...
 * @author Diemex
 */
public class MhcSkeletonDeflectEvent extends Event implements Cancellable
{
     ...
     */
    public MhcSkeletonDeflectEvent (Player shooter, Skeleton skeleton, int deflectPercentage)
    {
     ...
     * @param deflectPercentage the percentage of arrows a Skeleton deflects
     */
    public MhcSkeletonDeflectEvent (Player shooter, Skeleton skeleton, int deflectPercentage, boolean cancelled)
    {
