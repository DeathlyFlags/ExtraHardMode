...
/**
 * This Event is called everytime Mhc determines if it should respawn a Zombie.
 *
 * @author Diemex
 */
public class MhcZombieRespawnEvent extends Event implements Cancellable
{
     ...
     */
    public MhcZombieRespawnEvent (final Player player, final Zombie zombie)
    {
        this.player = player;
        this.zombie = zombie;
    }
     ...
     */
    public MhcZombieRespawnEvent (final Player player, final Zombie zombie, boolean cancelled)
    {
        this(player, zombie);
