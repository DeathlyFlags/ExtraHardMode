...
package com.megahardcore.events;
...
/**
 * This Event is called when MHC determines if a tool is supposed to be affected by the hardened stone code. It will be
...
public class MhcHardenedStoneEvent extends Event
{
    /**
     ...
     */
    public MhcHardenedStoneEvent (Player player, ItemStack tool, short numOfBlocks)
    {
        this.player = player;
        this.tool = tool;
    ...
    /**
     * Set the amount of blocks the tool can mine Just set this higher than 0 and mhc will allow the tool to break
     * blocks
     */
