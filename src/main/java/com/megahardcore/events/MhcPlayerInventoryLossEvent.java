 ...
 * @author Diemex
 */
public class MhcPlayerInventoryLossEvent extends Event implements Cancellable
{
    /**
     * Player who died
     */
     ...
     */
    public MhcPlayerInventoryLossEvent (PlayerDeathEvent event, List<ItemStack> drops, List<ItemStack> stacksToRemove)
    {
        this.event = event;
