 ...
 * @author Diemex
 */
public class MhcCreeperDropTntEvent extends Event implements Cancellable
{
     ...
     */
    public MhcCreeperDropTntEvent (final Player player, final Creeper creeper, Location location)
    {
        this.player = player;
