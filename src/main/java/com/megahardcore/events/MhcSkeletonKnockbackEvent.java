 ...
 * @author Diemex
 */
public class MhcSkeletonKnockbackEvent extends Event implements Cancellable
{
     ...
     */
    public MhcSkeletonKnockbackEvent (Entity entity, Skeleton skeleton, Vector velocity, int knockbackPercentage)
    {
        this.entity = entity;
     ...
     */
    public MhcSkeletonKnockbackEvent (Entity entity, Skeleton skeleton, Vector velocity, int deflectPercentage, boolean cancelled)
    {
