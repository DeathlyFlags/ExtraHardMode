 ...
 * @author Diemex
 */
public class MhcEndermanTeleportEvent extends Event implements Cancellable
{
     ...
     * Constructor
     */
    public MhcEndermanTeleportEvent (Player player, Enderman enderman, Location teleportTo)
    {
        this.player = player;
     ...
     */
    public MhcEndermanTeleportEvent (Player shooter, Enderman enderman, Location teleportTo, boolean cancelled)
    {
