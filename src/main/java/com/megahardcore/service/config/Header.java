...
public class Header
{
    ...
    {
        mLines.addAll(
                lines.stream().map(line -> "# " + line + StringUtils.repeat(" ", mLineSize - 2 - line.length() - 1).concat(System.lineSeparator())).collect(Collectors.toList()));
    }
    ...
    public String toString()
    {
        ...
        //top box line
        sb.append(StringUtils.repeat("#", mLineSize)).append(System.lineSeparator());
        //centered heading
