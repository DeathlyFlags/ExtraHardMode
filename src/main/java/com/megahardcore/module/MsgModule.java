...
/** @author Max */
public class MsgModule extends MHCModule
{
    ...
    /** Constructor */
    public MsgModule (MegaHardCore plugin)
    {
        super(plugin);
    }
    ...
    {
        sendPopup(player, category, Collections.singletonList(message), messages.getBoolean(MessageNode.SB_MSG_REMOVE_COLOR));
    }
     ...
     *
     * @return the manager used by megahardcore
     */
