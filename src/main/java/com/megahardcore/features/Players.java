...
import com.megahardcore.events.MhcPlayerExtinguishFireEvent;
import com.megahardcore.events.MhcPlayerInventoryLossEvent;
import com.megahardcore.module.DataStoreModule;
import com.megahardcore.module.PlayerData;
...
import com.megahardcore.task.SetPlayerHealthAndFoodTask;
...
public class Players extends ListenerModule
{
     ...
     * Constructor
     */
    public Players (MegaHardCore plugin)
    {
        super(plugin);
    }
    ...
    public void onPlayerRespawn(PlayerRespawnEvent respawnEvent)
    {
        ...
        {
            //TODO HIGH MhcPlayerRespawnEvent
    ...
    public void onEntityDeath(PlayerDeathEvent event)
    {
        ...
        if (!playerBypasses && enableItemLoss)
        {
            ...
            MhcPlayerInventoryLossEvent inventoryLossEvent = new MhcPlayerInventoryLossEvent(event, drops, removedDrops);
            ...
            if (enhancedEnvironmentalDmg && !playerBypasses)
            {
                ...
                switch (cause)
                {
                    ...
                    case ENTITY_EXPLOSION:
                        //TODO MhcPlayerEnvironmentalDamageEvent for each type
...
//                        player.addPotionEffect(new PotionEffect(PotionEffectType.BLINDNESS, 20, 1));
    ...
    void onPlayerInteract(PlayerInteractEvent event)
    {
                ...
                (action.equals(Action.LEFT_CLICK_BLOCK) || action.equals(Action.LEFT_CLICK_AIR)))
        {
            ...
            {
                MhcPlayerExtinguishFireEvent fireEvent = new MhcPlayerExtinguishFireEvent(player, 100);  // 20L ~ 1 seconds; 100L ~ 5 seconds
