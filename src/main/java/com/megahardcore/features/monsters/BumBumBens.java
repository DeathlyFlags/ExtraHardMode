...
import com.megahardcore.events.MhcCreeperDropTntEvent;
import com.megahardcore.events.fakeevents.FakeEntityExplodeEvent;
...
import com.megahardcore.task.CoolCreeperExplosion;
...
public class BumBumBens extends ListenerModule
{
    ...
    public BumBumBens (MegaHardCore plugin)
    {
        super(plugin);
    }
    ...
    public void onEntityDeath(EntityDeathEvent event)
    {
        ...
        if (creeperDropTNTPercent > 0)
        {
                    ...
                    && creeperDropTntMaxY > entity.getLocation().getBlockY())
            {
                ...
                MhcCreeperDropTntEvent dropTntEvent = new MhcCreeperDropTntEvent(player, (Creeper) entity, entity.getLocation());
