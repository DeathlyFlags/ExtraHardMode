...
import com.megahardcore.events.MhcSkeletonDeflectEvent;
import com.megahardcore.module.EntityHelper;
import com.megahardcore.service.ListenerModule;
import com.megahardcore.service.OurRandom;
...
public class Skeletors extends ListenerModule
{
    ...
    private final static String key_knockbackArrow      = "mhc.skeletors.knockbackarrow";
    private final static String key_slownessArrow       = "mhc.skeletors.slownessArrow";
    private final static String key_fireArrow           = "mhc.skeletons.explosionArrows";
    private final static String key_spawnedMinions      = "megahardcore.skeleton.minions";
    private final static String key_totalSpawnedMinions = "megahardcore.skeleton.minions.totalcount";
    private final static String key_parent              = "megahardcore.minion.parent";
    private final static String key_minionTag           = "megahardcore.skeleton.minion";
     ...
     */
    public Skeletors (MegaHardCore plugin)
    {
        super(plugin);
    }
    ...
    public void onSkeliDamagedByArrow(EntityDamageByEntityEvent event)
    {
        ...
        if (entity instanceof Skeleton && deflectPercent > 0)
        {
            ...
            if (damageSource instanceof Arrow)
            {
                ...
                MhcSkeletonDeflectEvent skeliEvent = new MhcSkeletonDeflectEvent(player, (Skeleton) entity, deflectPercent, !plugin.random(deflectPercent));
