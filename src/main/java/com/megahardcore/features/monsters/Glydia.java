...
import com.megahardcore.task.DragonAttackPatternTask;
import com.megahardcore.task.DragonAttackTask;
...
public class Glydia extends ListenerModule
{
    ...
    public Glydia (MegaHardCore plugin)
    {
        super(plugin);
    }
    ...
    public void onBlockBreak(BlockBreakEvent breakEvent)
    {
        ...
        if (endNoBuilding && world.getEnvironment() == World.Environment.THE_END && !playerBypass)
        {
            ...
            } else
            {
                ...
                {
                    breakEvent.setCancelled(true);
                    //TODO MhcLimitedBuildingEvent End
                    messenger.send(player, MessageNode.LIMITED_END_BUILDING);
                }
            }
        }
