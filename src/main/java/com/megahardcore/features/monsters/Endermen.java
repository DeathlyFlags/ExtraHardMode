...
import com.megahardcore.events.MhcEndermanTeleportEvent;
...
public class Endermen extends ListenerModule
{
    ...
    public Endermen (MegaHardCore plugin)
    {
        super(plugin);
    }
    ...
    public void onEntityTeleport(EntityTeleportEvent event)
    {
        ...
        if (entity instanceof Enderman && improvedEndermanTeleportation && world.getEnvironment().equals(World.Environment.NORMAL))
        {
            ...
            if (plugin.random(50))
            {
                ...
                MhcEndermanTeleportEvent teleportEvent = new MhcEndermanTeleportEvent(player, enderman, destinationBlock.getLocation());
