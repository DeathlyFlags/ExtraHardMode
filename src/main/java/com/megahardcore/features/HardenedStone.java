...
import com.megahardcore.events.MhcHardenedStoneEvent;
...
public class HardenedStone extends ListenerModule
{
    ...
    public HardenedStone (MegaHardCore plugin)
    {
        super(plugin);
    }
    ...
    public void onBlockBreak(BlockBreakEvent event)
    {
        ...
        if (hardStoneEnabled && hardBlocks.contains(block) && !playerBypasses)
        {
            ...
            if (inHandStack != null)
            {
                ...
                MhcHardenedStoneEvent hardEvent = new MhcHardenedStoneEvent(player, inHandStack, blocks);
