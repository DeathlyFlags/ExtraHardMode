...
public class Tutorial extends ListenerModule
{
    ...
    public Tutorial (MegaHardCore plugin)
    {
        super(plugin);
    }
    ...
    public void onZombieRespawn (MhcZombieRespawnEvent event)
    {
     ...
     */
    @EventHandler
    public void onCreeperDropTnt (MhcCreeperDropTntEvent event)
    {
        final Player player = event.getPlayer();
        if (player != null)
        {
     ...
     */
    @EventHandler(ignoreCancelled = true)
    public void onSkeletonDeflect (MhcSkeletonDeflectEvent event)
    {
     ...
     */
    @EventHandler
    public void onExtinguishFire (MhcPlayerExtinguishFireEvent event)
    {
     ...
     */
    @EventHandler
    public void onPlayerInventoryLoss (MhcPlayerInventoryLossEvent event)
    {
