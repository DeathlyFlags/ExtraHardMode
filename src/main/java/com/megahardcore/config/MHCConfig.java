...
import com.megahardcore.service.config.*;
...
public class MHCConfig
{
     ...
     */
    public MHCConfig (FileConfiguration config, String fullFilePath)
    {
        this.mConfig = config;
     ...
     */
    public MHCConfig (FileConfiguration config, File file)
    {
        this.mConfig = config;
        mConfigFile = file;
    }
