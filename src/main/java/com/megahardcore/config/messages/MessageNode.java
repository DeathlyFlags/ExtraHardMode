...
{
    /**
     * Display messages from megahardcore in the scoreboard instead of spamming the chat?
     */
    SB_MSG_ENABLE("Display Messages In Scoreboard.Enable", VarType.BOOLEAN, true),
    /**
     * Display messages from megahardcore in the scoreboard instead of spamming the chat?
     */
    SB_MSG_TITLE("Display Messages In Scoreboard.Scoreboard Title", VarType.STRING, SubType.PLAYER_NAME, ChatColor.RED + "MegaHardCore"),
    /**
     * Display messages from megahardcore in the scoreboard instead of spamming the chat?
     */
